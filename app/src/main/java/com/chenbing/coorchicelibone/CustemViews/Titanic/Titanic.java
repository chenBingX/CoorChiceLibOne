package com.chenbing.coorchicelibone.CustemViews.Titanic;
    ...
    public void start(final TitanicTextView textView) {
        ...
        final Runnable animate = new Runnable() {
            ...
            public void run() {
                ...
                ObjectAnimator maskXAnimator = ObjectAnimator.ofFloat(textView, "maskX", 0, DisplayUtils.dipToPx(200));
                maskXAnimator.setRepeatCount(ValueAnimator.INFINITE); //使用无限重复模式
