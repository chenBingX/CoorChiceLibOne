...
public class AppUtils {
    ...
    public static boolean PackageIsExist(String packageName) {
        PackageManager packageManager = IceApplication.getAppContext().getPackageManager();
        try {
    ...
    public static void checkPermission(Activity act, int requestCode, String... permission) {
        if (permission == null) return;

        int permissionCheck;
        for (String s : permission) {
            permissionCheck = ContextCompat.checkSelfPermission(act, s);
